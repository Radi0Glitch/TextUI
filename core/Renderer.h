...
public:
    ...
    static void drawLineHorizontal(int x, int y, int length, char ch, const ColorStyle& style = ColorStyle());
    static void drawLineVertical(int x, int y, int length, char ch, const ColorStyle& style = ColorStyle());
